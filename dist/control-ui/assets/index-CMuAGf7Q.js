      ...
      <div class="usage-mosaic-grid">
        ...
        <div class="usage-mosaic-section">
          ...
          <div class="usage-hour-grid">
            ${i.hourTotals.map((r,l)=>{const d=Math.min(r/o,1),g=r>0?`rgba(255, 77, 77, ${.08+d*.7})`:"transparent",u=`${l}:00 · ${z(r)} tokens`,p=d>.7?"rgba(255, 77, 77, 0.6)":"rgba(255, 77, 77, 0.2)",m=n.includes(l);return c`
                <div
...
`)},Ah=(e,t,n)=>{const s=e.trim();if(!s)return[];const i=s.length?s.split(/\s+/):[],o=i.length?i[i.length-1]:"",[a,r]=o.includes(":")?[o.slice(0,o.indexOf(":")),o.slice(o.indexOf(":")+1)]:["",""],l=a.toLowerCase(),d=r.toLowerCase(),g=E=>{const A=new Set;for(const S of E)S&&A.add(S);return Array.from(A)},u=g(t.map(E=>E.agentId)).slice(0,6),p=g(t.map(E=>E.channel)).slice(0,6),m=g([...t.map(E=>E.modelProvider),...t.map(E=>E.providerOverride),...n?.byProvider.map(E=>E.provider)??[]]).slice(0,6),v=g([...t.map(E=>E.model),...n?.byModel.map(E=>E.model)??[]]).slice(0,6),y=g(n?.tools.tools.map(E=>E.name)??[]).slice(0,6);if(!l)return[{label:"agent:",value:"agent:"},{label:"channel:",value:"channel:"},{label:"provider:",value:"provider:"},{label:"model:",value:"model:"},{label:"tool:",value:"tool:"},{label:"has:errors",value:"has:errors"},{label:"has:tools",value:"has:tools"},{label:"minTokens:",value:"minTokens:"},{label:"maxCost:",value:"maxCost:"}];const C=[],L=(E,A)=>{for(const S of A)(!d||S.toLowerCase().includes(d))&&C.push({label:`${E}:${S}`,value:`${E}:${S}`})};switch(l){case"agent":L("agent",u);break;case"channel":L("channel",p);break;case"provider":L("provider",m);break;case"model":L("model",v);break;case"tool":L("tool",y);break;case"has":["errors","tools","context","usage","model","provider"].forEach(E=>{(!d||E.includes(d))&&C.push({label:`has:${E}`,value:`has:${E}`})});break}return C},Ch=(e,t)=>{const n=e.trim();if(!n)return`${t} `;const s=n.split(/\s+/);return s[s.length-1]=t,`${s.join(" ")} `},Bt=e=>e.trim().toLowerCase(),Th=(e,t)=>{const n=e.trim();if(!n)return`${t} `;const s=n.split(/\s+/),i=s[s.length-1]??"",o=t.includes(":")?t.split(":")[0]:null,a=i.includes(":")?i.split(":")[0]:null;return i.endsWith(":")&&o&&a===o?(s[s.length-1]=t,`${s.join(" ")} `):s.includes(t)?`${s.join(" ")} `:`${s.join(" ")} ${t} `},fr=(e,t)=>{const s=e.trim().split(/\s+/).filter(Boolean).filter(i=>i!==t);return s.length?`${s.join(" ")} `:""},hr=(e,t,n)=>{const s=Bt(t),o=[...Go(e).filter(a=>Bt(a.key??"")!==s).map(a=>a.raw),...n.map(a=>`${t}:${a}`)];return o.length?`${o.join(" ")} `:""};function vt(e,t){return t===0?0:e/t*100}function _h(e){const t=e.totalCost||0;return{input:{tokens:e.input,cost:e.inputCost||0,pct:vt(e.inputCost||0,t)},output:{tokens:e.output,cost:e.outputCost||0,pct:vt(e.outputCost||0,t)},cacheRead:{tokens:e.cacheRead,cost:e.cacheReadCost||0,pct:vt(e.cacheReadCost||0,t)},cacheWrite:{tokens:e.cacheWrite,cost:e.cacheWriteCost||0,pct:vt(e.cacheWriteCost||0,t)},totalCost:t}}function Eh(e,t,n,s,i,o,a,r){if(!(e.length>0||t.length>0||n.length>0))return h;const d=n.length===1?s.find(v=>v.key===n[0]):null,g=d?(d.label||d.key).slice(0,20)+((d.label||d.key).length>20?"…":""):n.length===1?n[0].slice(0,8)+"…":`${n.length} sessions`,u=d?d.label||d.key:n.length===1?n[0]:n.join(", "),p=e.length===1?e[0]:`${e.length} days`,m=t.length===1?`${t[0]}:00`:`${t.length} hours`;return c`
  ...
  `}function Mh(e,t,n,s,i,o,a,r,l,d,g,u,p,m,v){const y=T=>p.includes(T),C=T=>{const q=T.label||T.key;return q.startsWith("agent:")&&q.includes("?token=")?q.slice(0,q.indexOf("?token=")):q},L=async T=>{const q=C(T);try{await navigator.clipboard.writeText(q)}catch{}},E=T=>{const q=[];return y("channel")&&T.channel&&q.push(`channel:${T.channel}`),y("agent")&&T.agentId&&q.push(`agent:${T.agentId}`),y("provider")&&(T.modelProvider||T.providerOverride)&&q.push(`provider:${T.modelProvider??T.providerOverride}`),y("model")&&T.model&&q.push(`model:${T.model}`),y("messages")&&T.usage?.messageCounts&&q.push(`msgs:${T.usage.messageCounts.total}`),y("tools")&&T.usage?.toolUsage&&q.push(`tools:${T.usage.toolUsage.totalCalls}`),y("errors")&&T.usage?.messageCounts&&q.push(`errors:${T.usage.messageCounts.errors}`),y("duration")&&T.usage?.durationMs&&q.push(`dur:${Lo(T.usage.durationMs,{spaced:!0})??"—"}`),q},A=T=>{const q=T.usage;if(!q)return 0;if(n.length>0&&q.dailyBreakdown&&q.dailyBreakdown.length>0){const Q=q.dailyBreakdown.filter(oe=>n.includes(oe.date));return s?Q.reduce((oe,Z)=>oe+Z.tokens,0):Q.reduce((oe,Z)=>oe+Z.cost,0)}return s?q.totalTokens??0:q.totalCost??0},S=[...e].toSorted((T,q)=>{switch(i){case"recent":return(q.updatedAt??0)-(T.updatedAt??0);case"messages":return(q.usage?.messageCounts?.total??0)-(T.usage?.messageCounts?.total??0);case"errors":return(q.usage?.messageCounts?.errors??0)-(T.usage?.messageCounts?.errors??0);case"cost":return A(q)-A(T);default:return A(q)-A(T)}}),D=o==="asc"?S.toReversed():S,_=D.reduce((T,q)=>T+A(q),0),R=D.length?_/D.length:0,b=D.reduce((T,q)=>T+(q.usage?.messageCounts?.errors??0),0),I=(T,q)=>{const Q=A(T),oe=C(T),Z=E(T);return c`
      ...
      >
        <div class="session-bar-label">
          ...
          ${Z.length>0?c`<div class="session-bar-meta">${Z.join(" · ")}</div>`:h}
        </div>
  ...
  `}function Bh(e,t,n,s){const i=Math.min(n,s),o=Math.max(n,s),a=t.filter(y=>y.timestamp>=i&&y.timestamp<=o);if(a.length===0)return;let r=0,l=0,d=0,g=0,u=0,p=0,m=0,v=0;for(const y of a)r+=y.totalTokens||0,l+=y.cost||0,u+=y.input||0,p+=y.output||0,m+=y.cacheRead||0,v+=y.cacheWrite||0,y.output>0&&g++,y.input>0&&d++;return{...e,totalTokens:r,totalCost:l,input:u,output:p,cacheRead:m,cacheWrite:v,durationMs:a[a.length-1].timestamp-a[0].timestamp,firstActivity:a[0].timestamp,lastActivity:a[a.length-1].timestamp,messageCounts:{total:a.length,user:d,assistant:g,toolCalls:0,toolResults:0,errors:0}}}function Hh(e,t,n,s,i,o,a,r,l,d,g,u,p,m,v,y,C,L,E,A,S,D,_,R,b,I){const U=e.label||e.key,M=U.length>50?U.slice(0,50)+"…":U,j=e.usage,V=r!==null&&l!==null,J=r!==null&&l!==null&&t?.points&&j?Bh(j,t.points,r,l):void 0,T=J?{totalTokens:J.totalTokens,totalCost:J.totalCost}:{totalTokens:j?.totalTokens??0,totalCost:j?.totalCost??0},q=J?" (filtered)":"";return c`
    <div class="card session-detail-panel">
      <div class="session-detail-header">
        <div class="session-detail-header-left">
          <div class="session-detail-title">
            ${M}
            ${q?c`<span style="font-size: 11px; color: var(--muted); margin-left: 8px;">${q}</span>`:h}
          </div>
        </div>
      ...
      <div class="session-detail-content">
        ${Uh(e,J,r!=null&&l!=null&&m?Oh(m,r,l):void 0)}
        <div class="session-detail-row">
          ${zh(t,n,s,i,o,a,g,u,p,r,l,d)}
        </div>
        <div class="session-detail-bottom">
          ${Kh(m,v,y,C,L,E,A,S,D,_,V?r:null,V?l:null)}
      ...
      <div class="timeseries-chart-wrapper" style="position: relative; cursor: crosshair;">
        ...
        >
          ...
          ${p.map((W,re)=>{const de=N[re],ve=T.left+re*(ue+ne),Ie=de/O*Q,Ze=T.top+Q-Ie,be=[new Date(W.timestamp).toLocaleDateString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),`${z(de)} tokens`];Z&&(be.push(`Out ${z(W.output)}`),be.push(`In ${z(W.input)}`),be.push(`CW ${z(W.cacheWrite)}`),be.push(`CR ${z(W.cacheRead)}`));const je=be.join(" · "),Xe=A&&(re<_||re>=R);if(!Z)return Lt`<rect x="${ve}" y="${Ze}" width="${ue}" height="${Ie}" class="ts-bar${Xe?" dimmed":""}" rx="1"><title>${je}</title></rect>`;const et=[{value:W.output,cls:"output"},{value:W.input,cls:"input"},{value:W.cacheWrite,cls:"cache-write"},{value:W.cacheRead,cls:"cache-read"}];let tt=T.top+Q;const dt=Xe?" dimmed":"";return Lt`
              ${et.map(ut=>{if(ut.value<=0||de<=0)return h;const Et=Ie*(ut.value/de);return tt-=Et,Lt`<rect x="${ve}" y="${tt}" width="${ue}" height="${Et}" class="ts-bar ${ut.cls}${dt}" rx="1"><title>${je}</title></rect>`})}
            `})}
        ...
        ${y.map(D=>{const{log:_,toolInfo:R,cleanContent:b}=D,I=_.role==="user"?"user":"assistant",U=_.role==="user"?"You":_.role==="assistant"?"Assistant":"Tool";return c`
          <div class="session-log-entry ${I}">
            <div class="session-log-meta">
              ...
              ${_.tokens?c`<span>${z(_.tokens)}</span>`:h}
            </div>
...
`);function Vh(e){if(e.loading&&!e.totals)return c`
  ...
  `};function nm(e){const t=e.hello?.snapshot,n=t?.sessionDefaults?.mainSessionKey?.trim();if(n)return n;const s=t?.sessionDefaults?.mainKey?.trim();return s||"main"}function sm(e,t){e.sessionKey=t,e.chatMessage="",e.chatStream=null,e.chatStreamStartedAt=null,e.chatRunId=null,e.resetToolStream(),e.resetChatScroll(),e.applySettings({...e.settings,sessionKey:t,lastActiveSessionKey:t})}function im(e,t){const n=Ys(t,e.basePath);return c`
    <a
      ...
      title=${Yi(t)}
    >
      <span class="nav-item__icon" aria-hidden="true">${fe[bp(t)]}</span>
  ...
  `}function av(e){const t=!!e.configForm&&!e.configLoading&&!e.configSaving,n=ni(e.configForm,e.agentId),s=Array.isArray(n.entry?.skills)?n.entry?.skills:void 0,i=new Set((s??[]).map(m=>m.trim()).filter(Boolean)),o=s!==void 0,a=!!(e.report&&e.activeAgentId===e.agentId),r=a?e.report?.skills??[]:[],l=e.filter.trim().toLowerCase(),d=l?r.filter(m=>[m.name,m.description,m.source].join(" ").toLowerCase().includes(l)):r,g=Jc(d),u=o?r.filter(m=>i.has(m.name)).length:r.length,p=r.length;return c`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
          ...
          <div class="card-sub">
            ...
            ${p>0?c`<span class="mono">${u}/${p}</span>`:h}
          </div>
        </div>
        <div class="row" style="gap: 8px;">
      ...
      ${d.length===0?c`
            ...
            `:c`
              <div class="agent-skills-groups" style="margin-top: 16px;">
                ${g.map(m=>rv(m,{agentId:e.agentId,allowSet:i,usingAllowlist:o,editable:t,onToggle:e.onToggle}))}
              </div>
            `}
    </section>
    ...
    <div class="agents-layout">
      ...
      <section class="agents-main">
        ${i?c`
                ...
                ${e.activePanel==="channels"?tv({context:Sr(i,e.configForm,e.agentFilesList,n,e.agentIdentityById[i.id]??null),configForm:e.configForm,snapshot:e.channelsSnapshot,loading:e.channelsLoading,error:e.channelsError,lastSuccess:e.channelsLastSuccess,onRefresh:e.onChannelsRefresh}):h}
                ${e.activePanel==="cron"?nv({context:Sr(i,e.configForm,e.agentFilesList,n,e.agentIdentityById[i.id]??null),agentId:i.id,jobs:e.cronJobs,status:e.cronStatus,loading:e.cronLoading,error:e.cronError,onRefresh:e.onCronRefresh}):h}
              `:c`
                <div class="card">
    ...
    <section class="card">
      ...
      <div class="agents-overview-grid" style="margin-top: 16px;">
        ...
        <div class="agent-kv">
          <div class="label">Identity Name</div>
          <div>${b}</div>
          ${V?c`<div class="agent-kv-sub muted">${V}</div>`:h}
        </div>
        <div class="agent-kv">
          <div class="label">Default</div>
          <div>${J?"yes":"no"}</div>
        ...
        <div class="row" style="gap: 12px; flex-wrap: wrap;">
          ...
          <label class="field" style="min-width: 260px; flex: 1;">
            ...
            <input
              ...
              @input=${T=>m(t.id,Pm(T.target.value))}
            />
          </label>
        </div>
  ...
  `}function Ct(e){const{schema:t,value:n,path:s,hints:i,unsupported:o,disabled:a,onPatch:r}=e,l=e.showLabel??!0,d=Re(t),{label:g,help:u,tags:p}=Xt(s,t,i),m=Ao(s),v=e.searchCriteria;if(o.has(m))return c`<div class="cfg-field cfg-field--error">
      ...
      <label class="cfg-toggle-row ${a?"disabled":""}">
        <div class="cfg-toggle-row__content">
          ...
          ${u?c`<span class="cfg-toggle-row__help">${u}</span>`:h}
          ${xt(p)}
        </div>
  ...
  `}function Rr(e){const{schema:t,value:n,path:s,hints:i,disabled:o,onPatch:a,inputType:r}=e,l=e.showLabel??!0,d=yt(s,i),{label:g,help:u,tags:p}=Xt(s,t,i),m=(d?.sensitive??!1)&&!/^\$\{[^}]*\}$/.test(String(n??"").trim()),v=d?.placeholder??(m?"••••":t.default!==void 0?`Default: ${String(t.default)}`:""),y=n??"";return c`
    <div class="cfg-field">
      ${l?c`<label class="cfg-field__label">${g}</label>`:h}
      ${u?c`<div class="cfg-field__help">${u}</div>`:h}
      ${xt(p)}
  ...
  `}function Ir(e){const{schema:t,value:n,path:s,hints:i,disabled:o,options:a,onPatch:r}=e,l=e.showLabel??!0,{label:d,help:g,tags:u}=Xt(s,t,i),p=n??t.default,m=a.findIndex(y=>y===p||String(y)===String(p)),v="__unset__";return c`
    <div class="cfg-field">
  ...
  `}function yv(e){const{schema:t,value:n,path:s,hints:i,unsupported:o,disabled:a,onPatch:r,searchCriteria:l}=e,d=e.showLabel??!0,{label:g,help:u,tags:p}=Xt(s,t,i),v=(l&&yn(l)?ea({schema:t,path:s,hints:i,criteria:l}):!1)?void 0:l,y=n??t.default,C=y&&typeof y=="object"&&!Array.isArray(y)?y:{},L=t.properties??{},A=Object.entries(L).toSorted((b,I)=>{const U=yt([...s,b[0]],i)?.order??0,M=yt([...s,I[0]],i)?.order??0;return U!==M?U-M:b[0].localeCompare(I[0])}),S=new Set(Object.keys(L)),D=t.additionalProperties,_=!!D&&typeof D=="object",R=c`
    ...
    ${_?xv({schema:D,value:C,path:s,hints:i,unsupported:o,disabled:a,reservedKeys:S,searchCriteria:v,onPatch:r}):h}
  `;return s.length===1?c`
    ...
    <details class="cfg-object" ?open=${s.length<=2}>
      ...
      ${u?c`<div class="cfg-object__help">${u}</div>`:h}
    ...
    <div class="cfg-array">
      <div class="cfg-array__header">
        <div class="cfg-array__title">
          ${d?c`<span class="cfg-array__label">${g}</span>`:h}
          ${xt(p)}
        </div>
  ...
  `}function xv(e){const{schema:t,value:n,path:s,hints:i,unsupported:o,disabled:a,reservedKeys:r,onPatch:l,searchCriteria:d}=e,g=fv(t),u=Object.entries(n??{}).filter(([m])=>!r.has(m)),p=d&&yn(d)?u.filter(([m,v])=>hn({schema:t,value:v,path:[...s,m],hints:i,criteria:d})):u;return c`
    <div class="cfg-map">
      <div class="cfg-map__header">
        ...
        <button
          ...
          class="cfg-map__add"
          ?disabled=${a}
          @click=${()=>{const m={...n};let v=1,y=`custom-${v}`;for(;y in m;)v+=1,y=`custom-${v}`;m[y]=g?{}:_l(t),l(s,m)}}
        >
      ...
      ${p.length===0?c`
        ...
        <div class="cfg-map__items">
          ${p.map(([m,v])=>{const y=[...s,m],C=hv(v);return c`
                ...
                <div class="cfg-map__item-header">
                  <div class="cfg-map__item-key">
                    <input
                      ...
                      .value=${m}
                      ?disabled=${a}
                      @change=${L=>{const E=L.target.value.trim();if(!E||E===m)return;const A={...n};E in A||(A[E]=A[m],delete A[m],l(s,A))}}
                    />
                  </div>
                  <button
                    type="button"
                    ...
                    title="Remove entry"
                    ?disabled=${a}
                    @click=${()=>{const L={...n};delete L[m],l(s,L)}}
                  >
                    ${Qn.trash}
                  </button>
                </div>
  ...
  `},ta={env:{label:"Environment Variables",description:"Environment variables passed to the gateway process"},update:{label:"Updates",description:"Auto-update settings and release channel"},agents:{label:"Agents",description:"Agent configurations, models, and identities"},auth:{label:"Authentication",description:"API keys and authentication profiles"},channels:{label:"Channels",description:"Messaging channels (Telegram, Discord, Slack, etc.)"},messages:{label:"Messages",description:"Message handling and routing settings"},commands:{label:"Commands",description:"Custom slash commands"},hooks:{label:"Hooks",description:"Webhooks and event hooks"},skills:{label:"Skills",description:"Skill packs and capabilities"},tools:{label:"Tools",description:"Tool configurations (browser, search, etc.)"},gateway:{label:"Gateway",description:"Gateway server settings (port, auth, binding)"},wizard:{label:"Setup Wizard",description:"Setup wizard state and history"},meta:{label:"Metadata",description:"Gateway metadata and version information"},logging:{label:"Logging",description:"Log levels and output configuration"},browser:{label:"Browser",description:"Browser automation settings"},ui:{label:"UI",description:"User interface preferences"},models:{label:"Models",description:"AI model configurations and providers"},bindings:{label:"Bindings",description:"Key bindings and shortcuts"},broadcast:{label:"Broadcast",description:"Broadcast and notification settings"},audio:{label:"Audio",description:"Audio input/output settings"},session:{label:"Session",description:"Session management and persistence"},cron:{label:"Cron",description:"Scheduled tasks and automation"},web:{label:"Web",description:"Web server and API settings"},discovery:{label:"Discovery",description:"Service discovery and networking"},canvasHost:{label:"Canvas Host",description:"Canvas rendering and display"},talk:{label:"Talk",description:"Voice and speech settings"},plugins:{label:"Plugins",description:"Plugin management and extensions"}};function Mr(e){return Lr[e]??Lr.default}function wv(e){if(!e.query)return!0;const t=Zc(e.query),n=t.text,s=ta[e.key];return n&&e.key.toLowerCase().includes(n)||n&&s&&(s.label.toLowerCase().includes(n)||s.description.toLowerCase().includes(n))?!0:hn({schema:e.schema,value:e.sectionValue,path:[e.key],hints:e.uiHints,criteria:t})}function Sv(e){if(!e.schema)return c`
    ...
    `;const s=new Set(e.unsupportedPaths??[]),i=t.properties,o=e.searchQuery??"",a=Zc(o),r=e.activeSection,l=e.activeSubsection??null,g=Object.entries(i).toSorted((p,m)=>{const v=yt([p[0]],e.uiHints)?.order??50,y=yt([m[0]],e.uiHints)?.order??50;return v!==y?v-y:p[0].localeCompare(m[0])}).filter(([p,m])=>!(r&&p!==r||o&&!wv({key:p,schema:m,sectionValue:n[p],uiHints:e.uiHints,query:o})));let u=null;if(r&&l&&g.length===1){const p=g[0]?.[1];p&&Re(p)==="object"&&p.properties&&p.properties[l]&&(u={sectionKey:r,subsectionKey:l,schema:p.properties[l]})}return g.length===0?c`
    ...
    <div class="config-form config-form--modern">
      ${u?(()=>{const{sectionKey:p,subsectionKey:m,schema:v}=u,y=yt([p,m],e.uiHints),C=y?.label??v.title??Ws(m),L=y?.help??v.description??"",E=n[p],A=E&&typeof E=="object"?E[m]:void 0,S=`config-section-${p}-${m}`;return c`
              <section class="config-section-card" id=${S}>
                <div class="config-section-card__header">
                  ...
                  <div class="config-section-card__titles">
                    ...
                    ${L?c`<p class="config-section-card__desc">${L}</p>`:h}
                  </div>
                </div>
            ...
            `})():g.map(([p,m])=>{const v=ta[p]??{label:p.charAt(0).toUpperCase()+p.slice(1),description:m.description??""};return c`
      ...
      <div style="margin-top: 16px; padding: 12px; background: var(--bg-secondary); border-radius: 8px;">
        ...
        ${b?c`
              <div class="status-list">
                ...
                ${S?c`<div><span class="label">Display Name</span><span>${S}</span></div>`:h}
                ${D?c`<div><span class="label">About</span><span style="max-width: 300px; overflow: hidden; text-overflow: ellipsis;">${D}</span></div>`:h}
  ...
  `}function Nv(e,t){const n=t.snapshot,s=n?.channels;if(!n||!s)return!1;const i=s[e],o=typeof i?.configured=="boolean"&&i.configured,a=typeof i?.running=="boolean"&&i.running,r=typeof i?.connected=="boolean"&&i.connected,d=(n.channelAccounts?.[e]??[]).some(g=>g.configured||g.running||g.connected);return o||a||r||d}function Ov(e,t){return t?.[e]?.length??0}function td(e,t){const n=Ov(e,t);return n<2?h:c`<div class="account-count">Accounts (${n})</div>`}function Uv(e){const{props:t,signal:n,accountCountLabel:s}=e;return c`
    <div class="card">
...
${d}`:d,i=i?`${i}
${g}`:g;let u=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(g,o,!0),this.lexer.state.top=u,n.length===0)break;let p=o.at(-1);if(p?.type==="code")break;if(p?.type==="blockquote"){let m=p,v=m.raw+`
`+n.join(`
`),y=this.blockquote(v);o[o.length-1]=y,s=s.substring(0,s.length-m.raw.length)+y.raw,i=i.substring(0,i.length-m.text.length)+y.text;break}else if(p?.type==="list"){let m=p,v=m.raw+`
`+n.join(`
`),y=this.list(v);o[o.length-1]=y,s=s.substring(0,s.length-p.raw.length)+y.raw,i=i.substring(0,i.length-m.raw.length)+y.raw,n=v.substring(o.at(-1).raw.length).split(`
...
`,1)[0],m=!u.trim(),v=0;if(this.options.pedantic?(v=2,g=u.trimStart()):m?v=t[1].length+1:(v=u.search(this.rules.other.nonSpaceChar),v=v>4?1:v,g=u.slice(v),v+=t[1].length),m&&this.rules.other.blankLine.test(p)&&(d+=p+`
...
`+_.slice(v);else{if(m||u.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||L.test(u)||E.test(u)||C.test(u))break;g+=`
`+p}m=!p.trim(),d+=D+`
...
`)?"":`
`)+i.raw,a.text+=`
`+i.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=a.text):n.push(i);continue}if(t){let a="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(a);break}else throw new Error(a)}}return this.state.top=!0,n}inline(t,n=[]){return this.inlineQueue.push({src:t,tokens:n}),n}inlineTokens(t,n=[]){let s=t,i=null;if(this.tokens.links){let l=Object.keys(this.tokens.links);if(l.length>0)for(;(i=this.tokenizer.rules.inline.reflinkSearch.exec(s))!=null;)l.includes(i[0].slice(i[0].lastIndexOf("[")+1,-1))&&(s=s.slice(0,i.index)+"["+"a".repeat(i[0].length-2)+"]"+s.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(i=this.tokenizer.rules.inline.anyPunctuation.exec(s))!=null;)s=s.slice(0,i.index)+"++"+s.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let o;for(;(i=this.tokenizer.rules.inline.blockSkip.exec(s))!=null;)o=i[2]?i[2].length:0,s=s.slice(0,i.index+o)+"["+"a".repeat(i[0].length-o-2)+"]"+s.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);s=this.options.hooks?.emStrongMask?.call({lexer:this},s)??s;let a=!1,r="";for(;t;){a||(r=""),a=!1;let l;if(this.options.extensions?.inline?.some(g=>(l=g.call({lexer:this},t,n))?(t=t.substring(l.raw.length),n.push(l),!0):!1))continue;if(l=this.tokenizer.escape(t)){t=t.substring(l.raw.length),n.push(l);continue}if(l=this.tokenizer.tag(t)){t=t.substring(l.raw.length),n.push(l);continue}if(l=this.tokenizer.link(t)){t=t.substring(l.raw.length),n.push(l);continue}if(l=this.tokenizer.reflink(t,this.tokens.links)){t=t.substring(l.raw.length);let g=n.at(-1);l.type==="text"&&g?.type==="text"?(g.raw+=l.raw,g.text+=l.text):n.push(l);continue}if(l=this.tokenizer.emStrong(t,s,r)){t=t.substring(l.raw.length),n.push(l);continue}if(l=this.tokenizer.codespan(t)){t=t.substring(l.raw.length),n.push(l);continue}if(l=this.tokenizer.br(t)){t=t.substring(l.raw.length),n.push(l);continue}if(l=this.tokenizer.del(t,s,r)){t=t.substring(l.raw.length),n.push(l);continue}if(l=this.tokenizer.autolink(t)){t=t.substring(l.raw.length),n.push(l);continue}if(!this.state.inLink&&(l=this.tokenizer.url(t))){t=t.substring(l.raw.length),n.push(l);continue}let d=t;if(this.options.extensions?.startInline){let g=1/0,u=t.slice(1),p;this.options.extensions.startInline.forEach(m=>{p=m.call({lexer:this},u),typeof p=="number"&&p>=0&&(g=Math.min(g,p))}),g<1/0&&g>=0&&(d=t.substring(0,g+1))}if(l=this.tokenizer.inlineText(d)){t=t.substring(l.raw.length),l.raw.slice(-1)!=="_"&&(r=l.raw.slice(-1)),a=!0;let g=n.at(-1);g?.type==="text"?(g.raw+=l.raw,g.text+=l.text):n.push(l);continue}if(t){let g="Infinite loop on byte: "+t.charCodeAt(0);if(this.options.silent){console.error(g);break}else throw new Error(g)}}return n}},Bs=class{options;parser;constructor(e){this.options=e||en}space(e){return""}code({text:e,lang:t,escaped:n}){let s=(t||"").match(ke.notSpaceStart)?.[0],i=e.replace(ke.endingNewline,"")+`
...
`:""}*No output — tool completed successfully.*`;t(u)}:void 0,r=i&&(e.text?.length??0)<=l0,l=i&&!r,d=i&&r,g=!i;return c`
    <div
      ...
      role=${o?"button":h}
      tabindex=${o?"0":h}
      @keydown=${o?u=>{u.key!=="Enter"&&u.key!==" "||(u.preventDefault(),a?.())}:h}
    >
      <div class="chat-tool-card__header">
        ...
        ${o?c`<span class="chat-tool-card__action">${i?"View":""} ${fe.check}</span>`:h}
        ${g&&!o?c`<span class="chat-tool-card__status">${fe.check}</span>`:h}
      </div>
      ${s?c`<div class="chat-tool-card__detail">${s}</div>`:h}
      ${g?c`
              <div class="chat-tool-card__status-text muted">Completed</div>
            `:h}
      ${l?c`<div class="chat-tool-card__preview mono">${u0(e.text)}</div>`:h}
  ...
  `}function fa(e,t){const n=ua(e),s=t?.name?.trim()||"Assistant",i=t?.avatar?.trim()||"",o=n==="user"?"U":n==="assistant"?s.charAt(0).toUpperCase()||"A":n==="tool"?"⚙":"?",a=n==="user"?"user":n==="assistant"?"assistant":n==="tool"?"tool":"other";return i&&n==="assistant"?$0(i)?c`<img
        ...
        src="${i}"
        alt="${s}"
      />`:c`<div class="chat-avatar ${a}">${i}</div>`:c`<div class="chat-avatar ${a}">${o}</div>`}function $0(e){return/^https?:\/\//i.test(e)||/^data:image\//i.test(e)||e.startsWith("/")}function x0(e){if(e.length===0)return h;const t=n=>{Ay(n,{allowDataImage:!0})};return c`
  ...
  `}function Rd(e,t,n){const s=e,i=typeof s.role=="string"?s.role:"unknown",o=Ad(e)||i.toLowerCase()==="toolresult"||i.toLowerCase()==="tool_result"||typeof s.toolCallId=="string"||typeof s.tool_call_id=="string",a=g0(e),r=a.length>0,l=m0(e),d=l.length>0,g=xc(e),u=t.showReasoning&&i==="assistant"?nf(e):null,p=g?.trim()?g:null,m=u?of(u):null,v=p,y=i==="assistant"&&!!v?.trim(),C=["chat-bubble",y?"has-copy":"",t.isStreaming?"streaming":"","fade-in"].filter(Boolean).join(" ");return!v&&r&&o?c`${a.map(L=>tl(L,n))}`:!v&&!r&&!d?h:c`
    <div class="${C}">
      ${y?My(v):h}
      ${x0(l)}
      ${m?c`<div class="chat-thinking">${ro(mo(m))}</div>`:h}
      ${v?c`<div class="chat-text" dir="${wd(v)}">${ro(mo(v))}</div>`:h}
      ${a.map(L=>tl(L,n))}
    </div>
  ...
  `}function L0(e){const t=e.connected,n=e.sending||e.stream!==null,s=!!(e.canAbort&&e.onAbort),o=e.sessions?.sessions?.find(m=>m.key===e.sessionKey)?.reasoningLevel??"off",a=e.showThinking&&o!=="off",r={name:e.assistantName,avatar:e.assistantAvatar??e.assistantAvatarUrl??null},l=(e.attachments?.length??0)>0,d=e.connected?l?"Add a message or paste more images...":"Message (↩ to send, Shift+↩ for line breaks, paste images)":"Connect to the gateway to start chatting…",g=e.splitRatio??.6,u=!!(e.sidebarOpen&&e.onCloseSidebar),p=c`
    ...
    >
      ${e.loading?c`
            ...
            `:h}
      ${zc(D0(e),m=>m.key,m=>m.kind==="divider"?c`
              <div class="chat-divider" role="separator" data-ts=${String(m.timestamp)}>
                <span class="chat-divider__line"></span>
                <span class="chat-divider__label">${m.label}</span>
                <span class="chat-divider__line"></span>
              </div>
            `:m.kind==="reading-indicator"?v0(r):m.kind==="stream"?b0(m.text,m.startedAt,e.onOpenSidebar,r):m.kind==="group"?y0(m,{onOpenSidebar:e.onOpenSidebar,showReasoning:a,assistantName:e.assistantName,assistantAvatar:r.avatar}):h)}
    </div>
  `;return c`
...
\`\`\``)}})}
      ...
      <div class="chat-compose">
        ${I0(e)}
        <button
          class="btn chat-new-session-btn"
          ...
          <label class="field chat-compose__field">
            ...
            <div class="chat-compose__input-wrapper">
              <textarea
                ...
                @input=${m=>{const v=m.target;nl(v),e.onDraftChange(v.value)}}
                @paste=${m=>R0(m,e)}
                placeholder=${d}
              ></textarea>
              <button
                ...
                title="${n?"Queue message":"Send message (Enter)"}"
              >
                ${fe.send}
              </button>
            </div>
...
${JSON.stringify(e.issues,null,2)}</pre
        ...
        <section class="card">
          ...
          <div class="cron-run-filters">
            ...
            <div class="cron-run-filters__row cron-run-filters__row--secondary">
              ...
              ${gl({id:"delivery",title:f("cron.runs.delivery"),summary:m,options:d,selected:e.runsDeliveryStatuses,onToggle:(S,D)=>{const _=cl(e.runsDeliveryStatuses,S,D);e.onRunsFiltersChange({cronRunsDeliveryStatuses:_})},onClear:()=>{e.onRunsFiltersChange({cronRunsDeliveryStatuses:[]})}})}
            </div>
          </div>
  ...
  `}function Qe(e,t){return e?c`<div id=${Ue(t)} class="cron-help cron-error">${f(e)}</div>`:h}function Y0(e,t){const s=`list-item list-item-clickable cron-job${t.runsJobId===e.id?" list-item-selected":""}`,i=o=>{t.onLoadRuns(e.id),o()};return c`
  ...
  `}function t$(e){switch(e){case"ok":return f("cron.runs.runStatusOk");case"error":return f("cron.runs.runStatusError");case"skipped":return f("cron.runs.runStatusSkipped");default:return f("cron.runs.runStatusUnknown")}}function n$(e){switch(e){case"delivered":return f("cron.runs.deliveryDelivered");case"not-delivered":return f("cron.runs.deliveryNotDelivered");case"not-requested":return f("cron.runs.deliveryNotRequested");case"unknown":return f("cron.runs.deliveryUnknown");default:return f("cron.runs.deliveryUnknown")}}function s$(e,t){const n=typeof e.sessionKey=="string"&&e.sessionKey.trim().length>0?`${Ys("chat",t)}?session=${encodeURIComponent(e.sessionKey)}`:null,s=t$(e.status??"unknown"),i=n$(e.deliveryStatus??"not-requested"),o=e.usage,a=o&&typeof o.total_tokens=="number"?`${o.total_tokens} tokens`:o&&typeof o.input_tokens=="number"&&typeof o.output_tokens=="number"?`${o.input_tokens} in / ${o.output_tokens} out`:null;return c`
    <div class="list-item cron-run-entry">
      ...
      <div class="list-meta cron-run-entry__meta">
        <div>${kt(e.ts)}</div>
        ${typeof e.runAtMs=="number"?c`<div class="muted">${f("cron.runEntry.runAt")} ${kt(e.runAtMs)}</div>`:h}
        <div class="muted">${e.durationMs??0}ms</div>
        ${typeof e.nextRunAtMs=="number"?c`<div class="muted">${X0(e.nextRunAtMs)}</div>`:h}
  ...
  `}function o$(e){const t=Math.max(0,e),n=Math.floor(t/1e3);if(n<60)return`${n}s`;const s=Math.floor(n/60);return s<60?`${s}m`:`${Math.floor(s/60)}h`}function Pt(e,t){return t?c`<div class="exec-approval-meta-row"><span>${e}</span><span>${t}</span></div>`:h}function a$(e){const t=e.execApprovalQueue[0];if(!t)return h;const n=t.request,s=t.expiresAtMs-Date.now(),i=s>0?`expires in ${o$(s)}`:"expired",o=e.execApprovalQueue.length;return c`
      ...
      <div class="list-item">
        ...
        <div class="list-meta">
          <label class="field">
            ...
            >
              ${t?h:c`<option value="__default__" ?selected=${g==="__default__"}>
      ...
      <div class="card">
        ...
        <div class="form-grid" style="margin-top: 16px;">
          ...
          <label class="field">
            ...
            >
              ${Tl.map(g=>{const u=g.replace(/-([a-zA-Z])/g,(p,m)=>m.toUpperCase());return c`<option value=${g}>${f(`languages.${u}`)}</option>`})}
            </select>
          </label>
        </div>
    ...
    <div class="shell ${l?"shell--chat":""} ${d?"shell--chat-focus":""} ${e.settings.navCollapsed?"shell--nav-collapsed":""} ${e.onboarding?"shell--onboarding":""}">
      ...
      <main class="content ${l?"content--chat":""}">
        ...
        <section class="content-header">
          <div>
            ${e.tab==="usage"?h:c`<div class="page-title">${Yi(e.tab)}</div>`}
