...
import { Bt as maskApiKey, a as DEFAULT_OAUTH_WARN_MS, d as runEmbeddedPiAgent, gt as resolveUsageProviderId, ht as formatUsageWindowSummary, o as buildAuthHealthSummary, pt as loadProviderUsageSummary, s as formatRemainingShort, zt as describeFailoverError } from "./reply-BDid6G6G.js";
...
import { t as ensureOpenClawModelsJson } from "./models-config-DcgFofw6.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-D1_F17BY.js";
...
import { r as resolveForwardCompatModel } from "./model-DaHMFgOH.js";
...
import { f as openUrl } from "./onboard-helpers-D2d0cdew.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-BvzhjBcb.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-B2dJKhsZ.js";
import { n as logConfigUpdated } from "./logging-BwKoeVdB.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-DxKAv4cA.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./model-selection-D5bdsDNY.js").then((n) => n.Lt);
	const { ensureAuthProfileStore } = await import("./model-selection-D5bdsDNY.js").then((n) => n.dt);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-DaHMFgOH.js").then((n) => n.t);
