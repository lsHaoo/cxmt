import { d as resolveSessionAgentId, r as resolveAgentConfig } from "./agent-scope-CmeamfDM.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-5c0Lz3Gi.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-5c0Lz3Gi.js")).closePlaywrightBrowserConnection();
		} catch {}
