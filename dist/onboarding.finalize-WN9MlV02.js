...
import { p as restoreTerminalState } from "./subsystem-CDGdCagb.js";
...
import { v as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-CkjEOGci.js";
...
import { b as waitForGatewayReachable, f as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, m as probeGatewayReachable, o as formatControlUiSshHint } from "./onboard-helpers-DNJKInQI.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DksmW04P.js").then((n) => n.r);
