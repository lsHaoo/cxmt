...
import { Nt as createDefaultDeps, _t as resolveCommitHash, t as getReplyFromConfig } from "./reply-BDid6G6G.js";
...
import { Hr as loadDotEnv, Vt as loadConfig } from "./model-selection-D5bdsDNY.js";
...
import { _ as applyTemplate, u as installUnhandledRejectionHandler } from "./runner-BD4XGEn4.js";
...
import { B as deriveSessionKey, V as resolveSessionKey, c as loadSessionStore, p as saveSessionStore } from "./sessions-CZ0UmHMC.js";
...
import { r as waitForever, t as monitorWebChannel } from "./channel-web-C4MrLL-o.js";
...
import { i as getCoreCliCommandsWithSubcommands, n as setProgramContext, o as registerProgramCommands, s as getSubCliCommandsWithSubcommands } from "./program-context-CckugpBw.js";
import "./plugin-registry-D1R11moK.js";
import { n as resolveCliChannelOptions } from "./channel-options-vOB8U2hr.js";
...
function registerPreActionHooks(program, programVersion) {
	program.hook("preAction", async (_thisCommand, actionCommand) => {
		...
		const { ensureConfigReady } = await import("./config-guard-D6A7a8WV.js");
		...
		if (PLUGIN_REQUIRED_COMMANDS.has(commandPath[0])) {
			const { ensurePluginRegistryLoaded } = await import("./plugin-registry-D1R11moK.js").then((n) => n.n);
