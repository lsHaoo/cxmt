...
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-n30bsiQh.js";
import { r as resolveForwardCompatModel } from "./model-B3Uxq_6Q.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-DCFV5662.js";
import { Cn as resolveUsageProviderId, Sn as formatUsageWindowSummary, Tt as describeFailoverError, bn as loadProviderUsageSummary, nn as buildAuthHealthSummary, rn as formatRemainingShort, s as runEmbeddedPiAgent, tn as DEFAULT_OAUTH_WARN_MS, wn as maskApiKey } from "./subagent-registry-BL8gsolN.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-CFZJ4dSy.js";
import { t as ensureOpenClawModelsJson } from "./models-config-CVdZOKZ0.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-DVGxdYmL.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-ISmf02Ub.js";
import { n as logConfigUpdated } from "./logging-CR-uu1KB.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers--dtQ8LZ2.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./auth-profiles-BxNoHpB2.js").then((n) => n.D);
	const { ensureAuthProfileStore } = await import("./auth-profiles-BxNoHpB2.js").then((n) => n.t);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-B3Uxq_6Q.js").then((n) => n.t);
