...
import { R as createConfigIO, U as writeConfigFile, tt as getBlockedNetworkModeReason, z as loadConfig } from "./model-selection-CqMDkb8n.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-BvYiVZNS.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-BvYiVZNS.js")).closePlaywrightBrowserConnection();
		} catch {}
